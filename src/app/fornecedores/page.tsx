              ...
              <TableBody>
                {fornecedores.map((fornecedor) => (
                  <TableRow key={fornecedor.id}>
                    ...
                    <TableCell>
                      {fornecedor.cnpj ? (
                        <Badge variant="outline">{formatCNPJ(fornecedor.cnpj)}</Badge>
                      ) : fornecedor.cpf ? (
                        <Badge variant="outline">{formatCPF(fornecedor.cpf)}</Badge>
                      ) : (
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        {fornecedor.telefone && (
                          <Badge variant="secondary">{formatPhone(fornecedor.telefone)}</Badge>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                      {fornecedor.endereco ? (
                        <div className="flex items-center gap-1 text-sm">
                          ...
                          <span className="truncate max-w-[200px]">{fornecedor.endereco}</span>
                        </div>
                      ) : (
